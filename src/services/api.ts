...
const mockMenuItems: MenuItem[] = [
  {
    ...
    price: 16,
    description: 'Fresh heirloom tomatoes from Green Valley Farm, house-made burrata, basil oil, aged balsamic',
    category: 'garden',
  ...
  },
  {
    ...
    price: 9,
    description: 'Daily changing soup featuring seasonal vegetables from our partner farms',
    category: 'garden',
    subcategory: 'appetizers',
    photos: [
  ...
  },
  {
    ...
    price: 42,
    description: '28-day dry-aged ribeye from Meadowridge Ranch, roasted garlic purée, herb-roasted potatoes, seasonal vegetables',
    category: 'fields',
    photos: [
  ...
  },
  {
    ...
    price: 28,
    description: 'Wild-caught salmon, lemon-dill sauce, quinoa pilaf, grilled asparagus',
    category: 'ocean',
    photos: [
  ...
  },
  {
    ...
    price: 24,
    description: 'Red curry with seasonal vegetables, coconut milk, jasmine rice, fresh herbs',
    category: 'harvest',
    photos: [
  ...
  },
  {
    ...
    price: 14,
    description: 'House-made infusion with seasonal fruits, herbs from our garden, premium spirits',
    category: 'beverages',
    photos: [
      ...
      if (filters?.dietary?.length) {
        filteredItems = filteredItems.filter(item => {
          return filters.dietary!.every(diet => {
            switch (diet) {
              case 'vegan': return item.dietary.vegan
              case 'vegetarian': return item.dietary.vegetarian
              case 'gluten-free': return item.dietary.gluten_free
              case 'halal': return item.dietary.halal
              default: return true
            }
          })
        })
