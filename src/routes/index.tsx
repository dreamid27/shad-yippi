...
function HomePage() {
	...
	useEffect(() => {
		...
		if (brandStoryRef.current)
			brandStoryObserver.observe(brandStoryRef.current);
	...
	const products = [
		{
			...
			price: 890,
			image:
				"https://images.unsplash.com/photo-1544966503-7e3c4c371b9c?w=800&h=1200&fit=crop",
			category: "Outerwear",
		},
		{
			id: 2,
			...
			price: 420,
			image:
				"https://images.unsplash.com/photo-1434389677669-e08b4cac3106?w=800&h=1200&fit=crop",
			category: "Knitwear",
		},
		{
			id: 3,
		...
		<div className="min-h-screen bg-black text-white overflow-x-hidden">
			...
			>
				...
				<div
					...
					style={{
						backgroundImage:
							"url(https://images.unsplash.com/photo-1539109136881-3be0616acf4b?w=1920&h=1080&fit=crop)",
				...
				<div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
					<h1
						className={`text-6xl md:text-8xl font-black mb-6 tracking-tighter transition-all duration-1000 ease-out ${
							isHeroVisible
					...
					>
						...
						<br />
						<span
							className={`block text-8xl md:text-9xl transition-all duration-700 delay-500 ${
								isHeroVisible
									? "opacity-100 transform translate-y-0"
									: "opacity-0 transform translate-y-8"
							}`}
					...
					<p
						className={`text-xl md:text-2xl mb-8 text-gray-300 font-light tracking-wide transition-all duration-700 delay-700 ${
							isHeroVisible
					...
					>
						<Link to="/categories">
							<Button
								size="lg"
								className="bg-white text-black hover:bg-gray-200 text-lg px-12 py-6 rounded-none transform hover:scale-105 transition-all duration-300"
							>
								EXPLORE COLLECTION
						...
						<Button
							variant="outline"
							size="lg"
							className="border-white text-white hover:bg-white hover:text-black text-lg px-12 py-6 rounded-none transform hover:scale-105 transition-all duration-300"
						>
							VIEW EDITORIAL
						</Button>
					</div>
				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-xl text-gray-400">
							Essential pieces reimagined through brutalist design
						</p>
					</div>

					<div className="grid md:grid-cols-2 gap-8">
						<div
							className={`group relative h-[600px] bg-gray-900 overflow-hidden cursor-pointer transition-all duration-1000 ease-out ${
								isCollectionsVisible
									? "opacity-100 translate-y-0"
									: "opacity-0 translate-y-12"
							}`}
						...
						>
							<div
								...
								style={{
									backgroundImage:
										"url(https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=800&h=1200&fit=crop)",
									backgroundSize: "cover",
									backgroundPosition: "center",
								}}
							/>
							<div className="relative h-full flex items-end p-8">
								<div className="bg-black/80 backdrop-blur-sm p-8">
									...
									<p className="text-gray-300 mb-4">
										Architectural silhouettes meets contemporary design
									</p>
						...
						>
							<div
								...
								style={{
									backgroundImage:
										"url(https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800&h=1200&fit=crop)",
									backgroundSize: "cover",
									backgroundPosition: "center",
								}}
							/>
							<div className="relative h-full flex items-end p-8">
								<div className="bg-black/80 backdrop-blur-sm p-8">
									...
									<p className="text-gray-300 mb-4">
										Pure forms reduced to their essential elements
									</p>
									<ArrowRight className="w-6 h-6" />
								</div>
							</div>
			...
			<section ref={productsRef} className="py-24 px-6 bg-gray-950">
				<div className="max-w-7xl mx-auto">
					<div
						className={`flex items-center justify-between mb-16 transition-all duration-1000 ease-out ${
							isProductsVisible
								? "opacity-100 translate-y-0"
								: "opacity-0 translate-y-12"
						}`}
					>
						...
						<Link to="/categories">
							<Button
								variant="outline"
								className="border-white text-white hover:bg-white hover:text-black px-8 py-4 rounded-none"
							>
								VIEW ALL
							</Button>
						</Link>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						{products.map((product, index) => (
							...
							>
								<div
									className={`relative h-[500px] bg-gray-900 overflow-hidden mb-4 transition-all duration-1000 ease-out ${
										isProductsVisible
											? "opacity-100 translate-y-0"
											: "opacity-0 translate-y-12"
									}`}
			...
			<section ref={brandStoryRef} className="py-24 px-6">
				<div className="max-w-5xl mx-auto text-center">
					<h2
						className={`text-5xl md:text-7xl font-black mb-12 tracking-tighter transition-all duration-1000 ease-out ${
							isBrandStoryVisible
								? "opacity-100 translate-y-0"
								: "opacity-0 translate-y-12"
						}`}
					...
					<div className="space-y-8 text-xl leading-relaxed text-gray-300">
						...
						>
							ÆTHER emerged from the intersection of architectural minimalism
							and contemporary fashion. We believe clothing should be structural
							yet fluid, bold yet restrained.
						</p>
						<p
						...
						>
							Each piece is a meditation on form, designed with brutalist
							precision and refined through meticulous attention to material and
							construction. Our silhouettes are defined by clean lines,
							unexpected proportions, and the interplay between shadow and
							light.
						</p>
						<p
